module MemeCaptainWeb
  ...
  module Config
    ...
    # Source images with any side longer than MaxSourceImageSide will be reduced. After reduction their maximum side
    # will be MaxSourceImageSide.
    MaxSourceImageSide = 800

    # Source images with their longest side shorter than MinSourceImageSide will be enlarged. After enlargement their
    # maximum side will be EnlargedSourceImageSide.
